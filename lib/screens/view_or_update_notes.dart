...
class _ViewNoteState extends State<ViewNote> {
  ...
  void initState() {
    ...
    titleController..text = widget.note.get('title');
    desController..text = widget.note.get('des');
  }
  @override
                    ...
                    InkWell(
                      onTap: (){
                        if(titleController.text.isEmpty || desController.text.isEmpty){
                          ...
                          firestore.collection('users').doc(currentUser!.email).collection('notes').doc(widget.note.id).set({
                      ...
                      child: Container(
                        ...
                        child: Text('Update', style: mTextStyle15(color: Colors.white),),
                      ),
                    )
                  ],
                ),
